...
export const metadata: Metadata = {
  title: 'How to Withdraw Money from Card Rummy – Fast Payout Guide 2026',
  description: 'Step-by-step guide to withdraw money from Card Rummy via JazzCash, EasyPaisa & Bank Card. Min PKR 100, Bank Card max PKR 20,000. Complete 2026 withdrawal guide for Pakistan.',
  keywords: ['withdraw money card rummy', 'card rummy withdrawal Pakistan', 'jazzcash withdrawal card rummy', 'easypaisa withdrawal card rummy', 'card rummy payout 2026'],
  openGraph: {
    title: 'How to Withdraw Money from Card Rummy – Fast Payout Guide 2026',
    description: 'Withdraw money from Card Rummy via JazzCash, EasyPaisa, or Bank Card. Min PKR 100. Step-by-step guide.',
    url: 'https://cardrummy.pk/withdraw-money-from-card-rummy',
    siteName: 'Card Rummy',
    type: 'article',
    images: [{ url: 'https://cardrummy.pk/blogimages/withdraw-money-card-rummy-pakistan.webp', width: 800, height: 400, alt: 'How to withdraw money from Card Rummy Pakistan via JazzCash and EasyPaisa' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'How to Withdraw Money from Card Rummy – Fast Payout Guide 2026',
    description: 'Withdraw Card Rummy winnings via JazzCash, EasyPaisa or Bank Card. Min PKR 100. Fast & secure.',
    images: ['https://cardrummy.pk/blogimages/withdraw-money-card-rummy-pakistan.webp'],
  },
  alternates: {
    canonical: 'https://cardrummy.pk/withdraw-money-from-card-rummy',
  },
};
      ...
      <section className="relative py-12 md:py-20 bg-secondary border-b border-gray-800">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <DownloadButton label="DOWNLOAD & START EARNING" />
      ...
      <section className="py-4 md:py-8">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <Image
              src="/blogimages/withdraw-money-card-rummy-pakistan.webp"
              alt="How to withdraw money from Card Rummy Pakistan – JazzCash, EasyPaisa and Bank Card withdrawal guide"
              width={800}
              height={400}
      ...
      <section className="py-6 md:py-10">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Withdrawal Limits &amp; Methods</h2>
            <div className="overflow-x-auto rounded-xl border border-gray-700">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-accent/10 border-b border-gray-700">
                    <th className="px-4 py-3 text-left text-accent font-semibold">Method</th>
                    ...
                    <th className="px-4 py-3 text-left text-accent font-semibold">Speed</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ["JazzCash", "PKR 100", "Per app limit", "Minutes–few hours"],
                    ["EasyPaisa", "PKR 100", "Per app limit", "Minutes–few hours"],
                    ["Bank Card", "—", "PKR 20,000", "Up to 24 hrs"],
                  ].map(([method, min, max, speed], i) => (
                    <tr key={method} className={i % 2 === 0 ? "bg-white/5" : "bg-transparent"}>
                      ...
                      <td className="px-4 py-3 text-green-400">{speed}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            </div>
            <p className="text-xs text-gray-500 mt-2">Check the app&apos;s Withdrawal section for current limits as they may vary.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-secondary rounded-2xl shadow-xl p-8 md:p-12">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                Follow all rules and withdrawal limits to avoid problems. It provides safe, quick withdrawals to all its users. You can securely collect your winnings and enjoy your favourite games in Card Rummy by following these simple steps.
              </p>
            </div>
          </div>
        </div>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "Article",
                "@id": "https://cardrummy.pk/withdraw-money-from-card-rummy#article",
                ...
                "mainEntityOfPage": { "@type": "WebPage", "@id": "https://cardrummy.pk/withdraw-money-from-card-rummy" },
                "inLanguage": "en-US",
                "hasPart": {
                  "@type": "HowTo",
                  "@id": "https://cardrummy.pk/withdraw-money-from-card-rummy#howto",
              ...
              {
                "@type": "FAQPage",
                "@id": "https://cardrummy.pk/withdraw-money-from-card-rummy#faq",
                "mainEntity": [
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Withdraw Money from Card Rummy", "item": "https://cardrummy.pk/withdraw-money-from-card-rummy" }
            ]
          })
        }}
      />
