...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://cardrummy.pk/privacy',
    siteName: 'Card Rummy',
    type: 'website',
  },
  alternates: {
    canonical: 'https://cardrummy.pk/privacy',
  },
};
          ...
          <div className="bg-secondary rounded-2xl shadow-xl p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-[#0A1029] rounded-xl p-6 mb-8">
                ...
                <p className="text-gray-300 mt-4">
                  To exercise any of these rights, please contact us at <a href="mailto:support@cardrummy.pk" className="text-accent hover:underline">support@cardrummy.pk</a>
              </p>
              </div>
              ...
              <div className="bg-accent/10 border-l-4 border-accent rounded-r-lg p-6 mb-4">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-center">
                    ...
                    <a href="mailto:support@cardrummy.pk" className="text-accent hover:underline">support@cardrummy.pk</a>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-accent mr-3" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <a href="https://www.cardrummy.pk" className="text-accent hover:underline" target="_blank" rel="noopener noreferrer">www.cardrummy.pk</a>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-accent mr-3" fill="currentColor" viewBox="0 0 20 20">
