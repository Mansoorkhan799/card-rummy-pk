...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://cardrummy.pk/disclaimer',
    siteName: 'Card Rummy',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://cardrummy.pk/disclaimer',
  },
  robots: {
    index: true,
    follow: true,
