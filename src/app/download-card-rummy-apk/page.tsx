...
export const metadata: Metadata = {
  ...
  description: `Download Card Rummy APK free for Android. Play Classic Rummy, 3 Patti Card Rummy, 7-card & 10-card rummy online. ${APP_VERSION}, 49 MB, Android 5.0+. Earn real cash via JazzCash & EasyPaisa Pakistan.`,
  keywords: [
    'Download Card Rummy',
  ...
  return (
    <article>
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": { "@type": "Answer", "text": `${APP_VERSION}, updated ${APP_LAST_UPDATED}. Always download the latest version for best performance and security.` }
              },
              {
                "@type": "Question",
      ...
      <section className="py-10 md:py-16 px-4 max-w-5xl mx-auto text-center">
        ...
        <p className="text-gray-400 text-lg mb-2">{APP_VERSION} · 49 MB · Android 5.0+ · Updated {APP_LAST_UPDATED}</p>
      ...
      <section className="py-6 px-4 max-w-5xl mx-auto text-center">
        <Image
          ...
          loading="lazy"
        />
        <p className="text-xs text-gray-500 mt-2">Card Rummy {APP_VERSION} – Game interface preview</p>
      </section>
      ...
      {/* What's New */}
      <section className="py-10 px-4 max-w-5xl mx-auto">
        <h2 className="text-2xl font-bold text-accent mb-5">What&apos;s New in {APP_VERSION}</h2>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {[
                ...
                ["App crashes on launch", `Clear the app cache or reinstall the latest ${APP_VERSION} APK.`],
      ...
      <section className="py-10 px-4 max-w-5xl mx-auto">
        ...
        <div className="space-y-3 max-w-2xl">
          {[
            ...
            { q: "What is the latest version?", a: `${APP_VERSION}, updated ${APP_LAST_UPDATED}. Always download the latest version for best performance and security.` },
      ...
      <section className="py-10 px-4 max-w-5xl mx-auto text-center">
        <div className="bg-accent/10 border border-accent/30 rounded-2xl p-8">
          ...
          <p className="text-gray-300 mb-6">Download the latest Card Rummy APK {APP_VERSION} and claim your 100% welcome bonus today. (18+ only.)</p>
          <DownloadButton label="DOWNLOAD CARD RUMMY APK" />
          <p className="text-xs text-gray-500 mt-4">Version {APP_VERSION} · 49 MB · Free · Android 5.0+</p>
        </div>
        <div className="mt-6">
