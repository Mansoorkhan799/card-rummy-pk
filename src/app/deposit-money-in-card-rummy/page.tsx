...
export const metadata: Metadata = {
  title: 'How to Deposit Money in Card Rummy – JazzCash & EasyPaisa Guide 2026',
  description: 'Step-by-step guide to deposit money in Card Rummy using JazzCash and EasyPaisa. Minimum PKR 100, instant balance — complete 2026 deposit guide for Pakistan.',
  keywords: ['deposit money card rummy', 'card rummy jazzcash deposit', 'card rummy easypaisa deposit', 'add money card rummy Pakistan', 'card rummy recharge 2026'],
  openGraph: {
    title: 'How to Deposit Money in Card Rummy – JazzCash & EasyPaisa Guide 2026',
    description: 'Step-by-step guide to deposit money in Card Rummy using JazzCash and EasyPaisa. Minimum PKR 100, instant balance.',
    url: 'https://cardrummy.pk/deposit-money-in-card-rummy',
    siteName: 'Card Rummy',
    type: 'article',
    images: [{ url: 'https://cardrummy.pk/blogimages/deposit-money-card-rummy-pakistan.webp', width: 800, height: 400, alt: 'How to deposit money in Card Rummy Pakistan via JazzCash and EasyPaisa' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'How to Deposit Money in Card Rummy – JazzCash & EasyPaisa Guide 2026',
    description: 'Deposit money in Card Rummy via JazzCash or EasyPaisa. Minimum PKR 100, instant. Complete 2026 guide.',
    images: ['https://cardrummy.pk/blogimages/deposit-money-card-rummy-pakistan.webp'],
  },
  alternates: {
    canonical: 'https://cardrummy.pk/deposit-money-in-card-rummy',
  },
};
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-secondary rounded-2xl shadow-xl p-8 md:p-12">
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                <Link href="/" className="text-accent hover:underline font-semibold">Card Rummy</Link> is an exciting online game where users can play many amazing games daily. If you haven't already, <a href="https://pkcardrummy.com/?from_gameid=6191689&channelCode=6113272" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline font-semibold">download Card Rummy</a> to get started. You need to deposit money to enjoy it without any problems. Adding funds to the Card Rummy Game is very easy, as it offers quick and safe payment methods, including JazzCash and Easy Paisa.
              </p>
      ...
      <section className="py-4 md:py-8">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <Image
              src="/blogimages/deposit-money-card-rummy-pakistan.webp"
              alt="How to deposit money in Card Rummy Pakistan – JazzCash and EasyPaisa deposit guide"
              width={800}
              height={400}
      ...
      <section className="py-6 md:py-10">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Deposit Limits &amp; Methods</h2>
            <div className="overflow-x-auto rounded-xl border border-gray-700">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ["JazzCash", "PKR 100", "Instant"],
                    ["EasyPaisa", "PKR 100", "Instant"],
                    ["Bank Transfer", "PKR 500", "Minutes–hours"],
                  ].map(([method, min, speed], i) => (
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "Article",
                "@id": "https://cardrummy.pk/deposit-money-in-card-rummy#article",
                ...
                "mainEntityOfPage": { "@type": "WebPage", "@id": "https://cardrummy.pk/deposit-money-in-card-rummy" },
                "inLanguage": "en-US",
                "hasPart": {
                  "@type": "HowTo",
                  "@id": "https://cardrummy.pk/deposit-money-in-card-rummy#howto",
              ...
              {
                "@type": "FAQPage",
                "@id": "https://cardrummy.pk/deposit-money-in-card-rummy#faq",
                "mainEntity": [
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Deposit Money in Card Rummy", "item": "https://cardrummy.pk/deposit-money-in-card-rummy" }
            ]
          })
        }}
      />
