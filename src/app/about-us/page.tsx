...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://cardrummy.pk/about-us",
  },
  openGraph: {
    title: 'About Card Rummy - Pakistan\'s Premier Card Gaming Platform',
    ...
    url: "https://cardrummy.pk/about-us",
    siteName: "Card Rummy",
    locale: "en_US",
    type: "website",
    images: [
  ...
  twitter: {
    ...
    title: 'About Card Rummy - Pakistan\'s Premier Card Gaming Platform',
    description: 'Learn about Card Rummy, our history, mission, and vision for creating the best card gaming platform in Pakistan with real cash rewards.',
    images: ["https://cardrummy.pk/card-rummy.webp"],
  },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": {
              ...
              "logo": "https://cardrummy.pk/card-rummy.webp",
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://cardrummy.pk/about-us"
            }
          })
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "About Us", "item": "https://cardrummy.pk/about-us" }
            ]
          })
        }}
      />
